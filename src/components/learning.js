    ...
    <div>
        <Grid container alignItems="center" justifyContent={"center"} >
            <Grid item lg={6} md={6} sm={12} xs={12}>
              ...
              <StyleTypography isMobile={isMobile}>Grow up your skills <br /> by online courses <br /> with Rears
</StyleTypography>
<StyleSmallTypography isMobile={isMobile}>Rears is a Global training provider based across the UK that specialises in <br /> accredited and bespoke training courses. We crush the barriers togetting a <br />degree.
